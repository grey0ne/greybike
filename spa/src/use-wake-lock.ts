...
//This is a copy of the original code from https://github.com/jorisre/react-screen-wake-lock because of installation issues
...
export const useWakeLock = ({
  ...
  if (wakeLock.current === null) {
      // If the wakeLock is not requested, request it on first use
      request();
  }
  return {
    isSupported,
